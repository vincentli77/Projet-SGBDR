import { verifyIfFileExistOnRemoteSession, countJsFileOnRemoteSession, convertInMsOnRemoteSession, verifyIfIpIsValidOnRemoteSession, findSmallestNumberOnRemoteSession } from "./index";
import { ICallback, defaultTest } from "./challenge/defaultTest";
